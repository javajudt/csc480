...
/**
 * You can see how to query the database.
 */
public class MainActivity extends AppCompatActivity {
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            try {
                db.execSQL( "insert into " + TABLE_NAME + "(name, age, phone) values ('John', 20, '605-677-7050');" );
                db.execSQL( "insert into " + TABLE_NAME + "(name, age, phone) values ('Mike', 35, '800-888-8888');" );
                db.execSQL( "insert into " + TABLE_NAME + "(name, age, phone) values ('Sean', 26, '605-634-7905');" );
            } catch(Exception ex) {
