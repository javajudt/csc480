...
/**
 * This is the most basic ways to use the database.
 */
public class MainActivity extends AppCompatActivity {
    ...
    private int insertRecord(String name) {
        ...
        int count = 3;
        db.execSQL( "insert into " + name + "(name, age, phone) values ('John', 20, '605-677-7050');" );
        db.execSQL( "insert into " + name + "(name, age, phone) values ('Mike', 35, '800-888-8888');" );
        db.execSQL( "insert into " + name + "(name, age, phone) values ('Sean', 26, '605-634-7905');" );
